  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-2">
                ...
                <a class="nav-link active border border-warning fs-4" href="#">Login</a>
                </li>
        ...
        <div class="container">
           <div class="row">
              <div class="col-md-4"></div>
                  <div class="col-md-5">
                    <div class="card position-absolute top-0 end-0 bg-dark" style="margin-right: 120px; margin-top: 200px; padding: 30px; " >
                    <div class="card-header text-white text-center">
                        <h1>IMS Log In</h1>
                    </div>
                    <div class="card-body p-5 mb-4 bg-warning" >
                    <form method="post" autocpmlete="off" action="<?=base_url('welcome/loginnow')?>">
                        <div class=" mb-3">
                        ...
                        <button type="submit" class="btn btn-dark fs-5">Log In</button>
                        </div>
                        <?php
                        if($this->session->flashdata('error')){  ?>
                            <p class="text-danger text-center" style="margin_top: 10px;"> <?=$this->session->flashdata('error')?></p>
                        <?php } ?>
